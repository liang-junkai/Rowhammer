...
int *hammer;
uintptr_t attackPages[100086], abovePages[100086], belowPages[100086],offset[100086];
 ...
 cpu_set_t set;
    ...
    while(fgets(line,sizeof(line),fp)!=NULL)
    {
    	...
    	if(token!=NULL && i==NUMBER_PAGES){
    	    if(offset[NUMBER_PAGES]>=8*0x280 && offset[NUMBER_PAGES] <(8*0x2a0)&& attackPages[NUMBER_PAGES]>0X100000){
