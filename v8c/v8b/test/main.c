...
static char sk2[]="FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF";
...
int main(){
	...
	sleep(3);
       ...
       // printf("PFN:%lx, logic address:%lx\n",getPage((uint8_t *)&d), &d);
        printf("sk2 PFN:%lx, logic address:%lx\n",getPage((uint8_t *)sk2), sk2);
        printf("size:%d\n",sizeof(sk2));
