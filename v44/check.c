...
int main(int argc, char *argv[]) {
    ...
    uintptr_t attackPages[NUMBER_PAGES] = { 0x17af70, 0X17af71};
    uintptr_t abovePages[NUMBER_PAGES] = { 0x17af56, 0x17af56};
    uintptr_t belowPages[NUMBER_PAGES] = { 0x17af8f, 0x17af8f};
